...
#function which takes value 'distance' and returns the number of trap locations within that distance of the central point
exppoints <- function(distance){
  
  #create a minigrid centred on {0,0}, with coordinates within x meters in all directions of that central point
